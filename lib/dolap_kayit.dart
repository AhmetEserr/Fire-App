...
import 'package:fire_appp/dolap_kayit_listesi.dart'; // DolapKayitListesi sayfasını import ettik
...
class _DolapKayitState extends State<DolapKayit> {
  ...
  Future<String?> uploadImage(File image) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Resim başarıyla eklendi')));
